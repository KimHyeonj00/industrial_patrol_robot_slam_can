...
본 레포지토리는 전체 팀 프로젝트 중 제가 담당한 **STM32 기반 임베디드 제어 및 하드웨어 연동 파트**를 중심으로 정리한 문서입니다.

<br>

## 📋 프로젝트 개요
- **프로젝트명:** SLAM 및 CAN 네트워크 기반 산업용 순찰 로봇
- **수행 기간:** 2026.XX.XX ~ 2026.XX.XX
- **개발 목표:**
  - LiDAR 기반 SLAM을 활용한 실내 작업장 지도 생성 및 순찰
  - YOLO 기반 안전모/안전조끼 착용 여부 탐지
  - CAN 통신 기반 Raspberry Pi 5 - STM32 제어 보드 연동
  - STM32 기반 센서 및 액추에이터 제어
  - 작업장 내 이상 상황 발생 시 LED, Buzzer 등을 통한 알림 제공
